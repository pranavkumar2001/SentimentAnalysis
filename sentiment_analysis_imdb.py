...
# If you get error "ValueError: Object arrays cannot be loaded when allow_pickle=False".
# then install numpy==1.16.1

#Import Libraries
import numpy
from numpy import array
from keras.datasets import imdb //importing the database
